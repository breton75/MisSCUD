#ifndef SV_SELECTDEPARTMENTDIALOG_H
#define SV_SELECTDEPARTMENTDIALOG_H
...
class SvSelectDepartmentDialog : public QDialog
{
    Q_OBJECT
  ...
  public:
    ...
    explicit SvSelectDepartmentDialog(QWidget *parent,
                                    bool showCreate = true,  
                                    bool showEditDelete = false);
    
    ~SvSelectDepartmentDialog();
...
#endif // SV_SELECTDEPARTMENTDIALOG_H
